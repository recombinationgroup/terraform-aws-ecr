...
| <a name="input_max_untagged_image_count"></a> [max\_untagged\_image\_count](#input\_max\_untagged\_image\_count) | How many untagged Image versions AWS ECR will store | `number` | `1` | no |
